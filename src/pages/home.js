      ...
      >
        <VStack spacing="0px" alignItems="center" w="full" maxW="800px">
          ...
          >
            ...
            >
              This is a resource for learning about the Tao Te Ching. Click any
              number in the grid below to see four public domain translations of
              that verse, plus the original Chinese text. Click any character of
              the Chinese text to open a new tab with Google Translate results
              showing various possible English translations of that character.
              Dive in now, or visit{" "}
              <chakra.span
                fontWeight={500}
                color="primary.300"
