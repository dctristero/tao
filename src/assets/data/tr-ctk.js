export const trCTK = [
  {
    id: 1,
    text: `The Tao that can be expressed is not the eternal Tao; The name that can be defined is not the unchanging name.
  ...
  {
    id: 2,
    text: `When all in the world understand beauty to be beautiful, then ugliness exists.
  ...
  {
    id: 3,
    text: `Not exalting the worthy keeps the people from emulation.
  ...
  {
    id: 4,
    text: `Tao, when put in use for its hollowness, is not likely to be filled.
  ...
  {
    id: 5,
    text: `Heaven and earth do not own their benevolence, To them all things are straw dogs
  ...
  {
    id: 7,
    text: `Heaven is lasting and earth enduring.
  ...
  {
    id: 8,
    text: `The highest goodness is like water. Water is beneficent to all things but does not contend. It stays in places which others despise. Therefore it is near Tao.
  ...
  {
    id: 9,
    text: `Holding and keeping a thing to the very full - it is better to leave it alone;
  ...
  {
    id: 10,
    text: `Can you keep the soul always concentrated from straying?
  ...
  {
    id: 11,
    text: `Thirty spokes unite in one nave, And because of the part where nothing exists we have the use of a carriage wheel.
  ...
  {
    id: 12,
    text: `The five colours will blind a man's sight. The five sounds will deaden a man's hearing. The five tastes will spoil a man's palate.
  ...
  {
    id: 13,
    text: `'Favour and disgrace are like fear; fortune and disaster are like our body.'
  ...
  {
    id: 14,
    text: `That which we look at and cannot see is called plainness. That which we listen to and cannot hear is called rareness. That which we grope for and cannot get is called minuteness.
  ...
  {
    id: 15,
    text: `In old times the perfect man of Tao was subtle, penetrating and so profound that he can hardly be understood.
  ...
  {
    id: 16,
    text: `Attain to the goal of absolute vacuity; Keep to the state of perfect peace.
  ...
  {
    id: 17,
    text: `The great rulers - the people do not notice their existence; The lesser ones - they attach to and praise them; The still lesser ones - they fear them; The still lesser ones - they despise them.
    For where faith is lacking, It cannot be met by faith.
    Now how much importance must be attributed to words!`
  },
  {
    id: 18,
    text: `When the great Tao is lost, spring forth benevolence and righteousness.
  ...
  {
    id: 19,
    text: `Do away with sageness and eject wisdom, and the people will be more benefited a hundred times.
  ...
  {
    id: 20,
    text: `Between yea and nay, how much difference is there? Between good and evil, how much difference is there?
  ...
  {
    id: 21,
    text: `The great virtue as manifested is but following Tao.
  ...
  {
    id: 22,
    text: `'Be humble, and you will remain entire.' Be bent, and you will remain straight. Be vacant, and you will remain full. Be worn, and you will remain new. He who has little will receive. He who has much will be embarrassed.
  ...
  {
    id: 23,
    text: `To be sparing of words is natural. A violent wind cannot last a whole morning; pelting rain cannot last a whole day.
  ...
  {
    id: 24,
    text: `A man on tiptoe cannot stand firm; A man astride cannot walk on;
  ...
  {
    id: 25,
    text: `There is a thing inherent and natural, Which existed before heaven and earth. Motionless and fathomless, It stands alone - and never changes; It pervades everywhere and never becomes exhausted. It may be regarded as the Mother of the Universe.
  ...
  {
    id: 26,
    text: `Heaviness is the basis of lightness; Calmness is the controlling power of hastiness.
  ...
  {
    id: 28,
    text: `He who knows the masculine and yet keeps to the feminine Will become a channel drawing all the world towards it; Being a channel of the world, he will not be severed from the eternal virtue, And then he can return again to the state of infancy.
  ...
  {
    id: 29,
    text: `When a man is to take the world over and shape it, I see that he must be obliged to do it.
  ...
  {
    id: 30,
    text: `He who assists a ruler of men with Tao does not force the world with arms.
  ...
  {
    id: 31,
    text: `So far as arms are concerned, they are implements of ill-omen. They are not implements for the man of Tao.
  ...
  {
    id: 32,
    text: `When for the first time applied to function, it was named. In as much as names are given, one should also know where to stop. Knowing where to stop one can become imperishable.
  ...
  {
    id: 34,
    text: `The great Tao pervades everywhere, both on the left and on the right.
  ...
  {
    id: 35,
    text: `To him who holds to the Great Form all the world will go. It will go and see no danger, but tranquillity, equality and community.
  ...
  {
    id: 36,
    text: `In order to contract a thing, one should surely expand it first. In order to weaken, one will surely strengthen first. In order to overthrow, one will surely exalt first. 'In order to take, one will surely give first'!
  ...
  {
    id: 37,
    text: `Tao is ever inactive, and yet there is nothing that it does not do.
  ...
  {
    id: 38,
    text: `The superior virtue is not conscious of itself as virtue; Therefore it has virtue. The inferior virtue never lets off virtue; Therefore it has no virtue.
  ...
  {
    id: 39,
    text: `From of old the things that have acquired Unity are these:
  ...
  {
    id: 40,
    text: `Returning is the motion of Tao.
  ...
  {
    id: 41,
    text: `When the superiour scholar is told of Tao,
  ...
  {
    id: 42,
    text: `Tao begets one; one begets two; two begets three; three begets all things. All things are backed by the Shade, (yin) and faced by the light (yang), and harmonised by the immaterial Breath (ch'i).
  ...
  {
    id: 43,
    text: `The non-existent can enter into the impenetrable.
  ...
  {
    id: 44,
    text: `Fame or your person, which is nearer to you?
  ...
  {
    id: 45,
    text: `The greatest perfection seems imperfect;
  ...
  {
    id: 46,
    text: `Swift horses are curbed for hauling dung-carts (in the field).
  ...
  {
    id: 47,
    text: `Without going out of the door
  ...
  {
    id: 48,
    text: `He who pursues learning will increase every day;
  ...
  {
    id: 49,
    text: `The Sage has no self to call his own.
  ...
  {
    id: 50,
    text: `Men go out of life and enter into death.
  ...
  {
    id: 51,
    text: `Tao produces them (all things);
    Virtue feeds them;
  ...
  {
    id: 52,
    text: `The beginning of the Universe, when manifested, may be regarded as its Mother.
  ...
  {
    id: 53,
    text: `Let me have sound knowledge and walk on the great way (Tao);
  ...
  {
    id: 54,
    text: `What is planted by the best planter can never be removed;
  ...
  {
    id: 58,
    text: `When the government is blunt and inactive the people will be happy and prosperous;
  ...
  {
    id: 59,
    text: `In ruling men and in serving heaven, the Sage uses only moderation.
  ...
  {
    id: 60,
    text: `Govern a great state as you would cook a small fish (do it gently).
  ...
  {
    id: 63,
    text: `Act non-action; undertake no undertaking; taste the tasteless.
  ...
  {
    id: 64,
    text: `What is motionless is easy to hold;
  ...
  {
    id: 65,
    text: `In olden times the best practitioners of Tao did not use it to awaken people to knowledge,
  ...
  {
    id: 66,
    text: `As Tao is to the world, so are streams and valleys to the rivers and seas.
  ...
  {
    id: 67,
    text: `All the world says to me: 'Great as Tao is, it resembles no description (form).' Because it is great, therefore it resembles no description. If it resembled any description it would have long since become small.
  ...
  {
    id: 68,
    text: `The best soldier is not soldierly;
  ...
  {
    id: 69,
    text: `An ancient tactician has said:
  ...
  {
    id: 70,
    text: `Words have an ancestor; deeds have a governor.
  ...
  {
    id: 71,
    text: `Not knowing that one knows is best;
  ...
  {
    id: 72,
    text: `If the people have no fear of their ruling authority, still greater fear will come.
  ...
  {
    id: 73,
    text: `He who shows courage in daring will perish;
  ...
  {
    id: 74,
    text: `When the people are not afraid of death, what use is it to frighten them with the punishment of death? If the people were constantly afraid of death and we could arrest and kill those who commit treacheries, who then would commit such? Only the Supreme Executioner kills. To kill in place of the Supreme Executioner is to hack instead of a great carpenter. Now if one hacks in place of a great carpenter one can scarcely avoid cutting one's own hand.`
  },
  {
    id: 75,
    text: `The people starve. Because their officials take heavy taxes from them, therefore they starve. The people are hard to rule. Because their officials meddle with affairs, therefore they are hard to rule. The people pay no heed to death. Because they endevour to seek life; therefore they pay no heed to death.`
  },
  {
    id: 76,
    text: `Man when living is soft and tender; when dead he is hard and tough. All animals and plants when living are tender and fragile; when dead they become withered and dry. Therefore it is said: the hard and the tough are parts of death, the soft and the tender are parts of life. This is the reason why soldiers when they are too tough cannot carry the day; the tree when it is too tough will break. The Position of the strong and great is low, and the position of the weak and tender is high.`
  },
  {
    id: 77,
    text: `Is not the Tao of heaven like the drawing of a bow? It brings down the part which is high; it raises the part which is low; it lessens the part which is redundant (convex); it fills up the part which is insufficient (concave). The Tao of heaven is to lessen the redundant and fill up the insufficient. The Tao of man, on the contrary, is to take from the insufficient and give to the redundant. Who can take from the redundant and give to the insufficient? Only he who has Tao can. Therefore the Sage does not horde. The more he helps others, the more he benefits himself the more he gives to others, the more he gets himself. The Tao of heaven does one good but never does one harm; the Tao of the Sage acts but never contends.`
  },
  {
    id: 78,
    text: `The weakest things in the world can overmatch the strongest things in the world.
  ...
  {
    id: 79,
    text: `Return love for great hatred.
